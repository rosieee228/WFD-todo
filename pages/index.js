...
export default function Home() {
  ...
  return (
    <div className="container">
      <h1>Welcome to WFD Drill Platform!</h1>
      <p>Practice Write From Dictation and improve your skills!</p>

      <div className="question">
        <p>{questions[currentQuestion]}</p>
      </div>

      <button onClick={() => alert("Start practicing!")}>Start Practice</button>
    </div>
  );
}
